...
<div class="row pt-5">
    ...
    <div class="form-group col-md-6">
        ...
        pattern="[A-Za-z0-9._%+-]+@[A-Za-z0-9.-]+\.[A-Za-z]{1,63}$" title="invalid">
    </div>
    <div class="form-group col-md-6">
    ...
    <div class="form-group col-md-4">
        ...
        <input type="text" class="form-control" id="rut" value="{{$usuario->rut}}" name="rut">
        <small><h6 id="result" ></h6></small>
    </div>
    <div class="form-group col-md-4">
    ...
    <img style="border-radius: 5%;" src="{{asset('storage').'/'.$usuario->foto}}" alt="" width="200px">
    <br>
